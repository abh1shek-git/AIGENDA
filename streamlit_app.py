...
genai.configure(api_key="AIzaSyCW8t0OoIOZFCFC2jHtj3SBrGg3-dhAnlM")
...
st.set_page_config(page_title="Invoice GEN")
st.sidebar.header("Invoice")
st.sidebar.write("Made by GRACZ")
st.sidebar.write("Powered by Google Gemini AI")
st.header("Invoice GEN")
st.subheader("Made by GRACZ")
st.subheader("Manage Your expenses with Invoice GEN")
